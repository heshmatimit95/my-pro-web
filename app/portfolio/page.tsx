...
این پروژه اثبات می‌کند که چگونه می‌توان با معماری هوشمندانه پایگاه داده، نیاز سازمان به نرم‌افزارهای گران‌قیمت ERP را برطرف کرد.`, 
  ...
  { 
    id: 5, 
    title: "سیستم گزارش‌گیری مدیریت فرآیندها BPMRS", 
    desc: "مانیتورینگ هوشمند فرآیندهای سازمانی با طراحی مدرن", 
    video: "/BPMRS.mp4", 
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    {projects.map((pro) => (
      ...
      >
        ...
        <h3 className="text-lg md:text-medium font-bold text-blue-950 truncate">
          {pro.title}
        </h3>
