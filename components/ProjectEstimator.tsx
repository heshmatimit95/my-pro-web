            ...
            <div key="form-steps">
              {step === 1 && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                  ...
                  {services.map((s: any) => (
                    <motion.button whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }} key={s.name} onClick={() => { setSelectedMainService(s); setStep(2); }} 
              ...
              {step === 2 && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                  ...
                  {selectedMainService?.plans.map((p: any) => (
                    <motion.div whileHover={{ scale: 1.01 }} key={p.name} onClick={() => { setSelectedPlan(p); setStep(3); }} 
              ...
              {step === 3 && (
                <motion.form key="step3" onSubmit={handleSubmitRequest} className="space-y-4" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
